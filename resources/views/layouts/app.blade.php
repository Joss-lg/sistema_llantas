            ...
            <div class="h-full flex flex-col transition-[width] duration-300 ease-[cubic-bezier(0.4,0,0.2,1)]"
                ...
                <div class="h-16 flex items-center border-b border-gray-200 dark:border-white/5 transition-all duration-300"
                    ...
                    <button
                        ...
                        class="group relative w-9 h-9 flex items-center justify-center rounded-xl text-gray-500 dark:text-gray-400 bg-transparent hover:bg-gray-100 dark:hover:bg-white/5 hover:text-[#818CF8] active:scale-90 transition-all duration-200 shrink-0">
                ...
                @auth
                    ...
                    --}}
                    @php
                        $puedeCaja            = Auth::user()->tienePermiso('caja.index');
                        $mostrarSeccionCaja   = $puedeCaja;
                    ...
                    <div class="px-4 pb-4 pt-2 transition-all duration-300"
                        ...
                        <div class="bg-gray-50 dark:bg-white/[0.03] rounded-2xl p-3 flex items-center gap-3 border border-gray-200 dark:border-white/10 transition-all duration-300"
                            ...
                            <div class="w-10 h-10 rounded-full bg-gradient-to-br from-[#818CF8] to-[#818CF8] text-white flex items-center justify-center font-bold text-lg shrink-0 ring-2 ring-white dark:ring-white/10 shadow-sm">
                            ...
                            <div class="flex flex-col overflow-hidden"
                                ...
                                <span class="text-[10px] uppercase tracking-wider font-semibold text-[#818CF8] bg-indigo-50 dark:bg-[#818CF8]/10 px-2 py-0.5 rounded-full w-max">
                    ...
                    <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto overflow-x-hidden">
                        ...
                        <a href="{{ route('dashboard') }}"
                           ...
                           {{ request()->routeIs('dashboard') ? 'bg-gradient-to-r from-[#818CF8]/10 to-transparent text-[#818CF8] font-semibold shadow-[inset_3px_0_0_0_#818CF8]' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-gray-100 hover:translate-x-0.5' }}"
                           :class="sidebarOpen ? '' : 'justify-center px-0'">
                            ...
                            <span class="whitespace-nowrap" x-show="sidebarOpen" x-transition:enter="transition ease-out duration-200 delay-100" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">Panel</span>
                        </a>

                        {{-- ============ CAJA ============ --}}
                        @if($mostrarSeccionCaja)
                            <div class="pt-5 pb-1 px-3" x-show="sidebarOpen" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                                <span class="text-[10px] font-bold uppercase tracking-widest text-gray-400 dark:text-gray-600">Finanzas</span>
                            </div>
                        ...
                        @if($mostrarSeccionVentas)
                            ...
                            @if($puedeVentasIndex)
                                <a href="{{ route('ventas.index') }}"
                                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200
                                   {{ request()->routeIs('ventas.index') ? 'bg-gradient-to-r from-[#818CF8]/10 to-transparent text-[#818CF8] font-semibold shadow-[inset_3px_0_0_0_#818CF8]' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-gray-100 hover:translate-x-0.5' }}"
                                   :class="sidebarOpen ? '' : 'justify-center px-0'">
                            ...
                            @if($puedeVentasHistorial)
                                <a href="{{ route('ventas.historial') }}"
                                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200
                                   {{ request()->routeIs('ventas.historial') ? 'bg-gradient-to-r from-[#818CF8]/10 to-transparent text-[#818CF8] font-semibold shadow-[inset_3px_0_0_0_#818CF8]' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-gray-100 hover:translate-x-0.5' }}"
                                   :class="sidebarOpen ? '' : 'justify-center px-0'">
                            ...
                            @if($puedeClientes)
                                <a href="{{ route('clientes.index') }}"
                                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200
                                   {{ request()->routeIs('clientes.*') ? 'bg-gradient-to-r from-[#818CF8]/10 to-transparent text-[#818CF8] font-semibold shadow-[inset_3px_0_0_0_#818CF8]' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-gray-100 hover:translate-x-0.5' }}"
                                   :class="sidebarOpen ? '' : 'justify-center px-0'">
                        ...
                        @if($mostrarSeccionInventario)
                            ...
                            @if($puedeInventario)
                                <a href="{{ route('inventario.index') }}"
                                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200
                                   {{ request()->routeIs('inventario.*') ? 'bg-gradient-to-r from-[#818CF8]/10 to-transparent text-[#818CF8] font-semibold shadow-[inset_3px_0_0_0_#818CF8]' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-gray-100 hover:translate-x-0.5' }}"
                                   :class="sidebarOpen ? '' : 'justify-center px-0'">
                        ...
                        @if($mostrarSeccionAdmin)
                            ...
                            @if($puedeEmpleados)
                                <a href="{{ route('empleados.index') }}"
                                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200
                                   {{ request()->routeIs('empleados.*') ? 'bg-gradient-to-r from-[#818CF8]/10 to-transparent text-[#818CF8] font-semibold shadow-[inset_3px_0_0_0_#818CF8]' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-gray-100 hover:translate-x-0.5' }}"
                                   :class="sidebarOpen ? '' : 'justify-center px-0'">
                            ...
                            @if($puedeReportes)
                                <a href="{{ route('reportes.index') }}"
                                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200
                                   {{ request()->routeIs('reportes.*') ? 'bg-gradient-to-r from-[#818CF8]/10 to-transparent text-[#818CF8] font-semibold shadow-[inset_3px_0_0_0_#818CF8]' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-gray-100 hover:translate-x-0.5' }}"
                                   :class="sidebarOpen ? '' : 'justify-center px-0'">
                    ...
                    <div class="p-4 border-t border-gray-100 dark:border-white/5">
                        <a href="{{ route('logout') }}"
                           ...
                           class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-[#818CF8] hover:bg-indigo-50 dark:hover:bg-[#818CF8]/10 hover:translate-x-0.5 transition-all duration-200"
                ...
                @guest
                    <div class="flex items-center gap-3">
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="text-sm font-bold bg-[#818CF8] text-white hover:bg-[#818CF8] px-4 py-2 rounded-md shadow-sm transition">
                                {{ __('Registro') }}
                            </a>
                        @endif
                    </div>
