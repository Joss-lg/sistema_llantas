...
<div class="max-w-7xl mx-auto space-y-6 transition-colors duration-500" 
    ...
    <div class="bg-white dark:bg-[#151515] rounded-2xl border border-gray-200 dark:border-neutral-800 p-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4 shadow-sm transform transition-all duration-700 delay-200 hover:shadow-md"
        ...
        <div class="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end">
            <div class="flex items-center gap-2">
                ...
                <select class="px-3 py-2 bg-gray-50 dark:bg-[#0A0A0A] border border-gray-200 dark:border-neutral-800 rounded-xl text-sm text-gray-700 dark:text-neutral-300 focus:outline-none focus:ring-2 focus:ring-[#D32030] transition-colors cursor-pointer hover:border-gray-300 dark:hover:border-neutral-600">
                    <option>Todas las sucursales</option>
                    <option>Administración General</option>
                    <option>Chalco</option>
                </select>
            </div>
            <button class="group inline-flex items-center gap-2 px-4 py-2 bg-[#D32030] text-white rounded-xl text-sm font-semibold hover:bg-[#B91C2C] hover:shadow-lg hover:shadow-red-500/30 transform hover:-translate-y-0.5 transition-all duration-300">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <!-- Tarjeta 3 -->
        <div class="bg-white dark:bg-[#151515] rounded-2xl p-6 border border-gray-200 dark:border-neutral-800 shadow-sm hover:shadow-xl hover:border-blue-200 dark:hover:border-blue-900/50 transform hover:-translate-y-1 transition-all duration-500 delay-500"
             :class="cargado ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'">
            <div class="flex items-center justify-between mb-4">
                <div class="w-11 h-11 rounded-xl bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-500 flex items-center justify-center transition-transform hover:-rotate-12 duration-300">
            ...
            <p class="text-3xl font-bold text-gray-900 dark:text-white mt-1 transition-colors">0</p>
            <p class="text-xs text-blue-500 dark:text-blue-500 font-medium mt-2 flex items-center gap-1 group">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-[#151515] rounded-2xl border border-gray-200 dark:border-neutral-800 p-6 shadow-sm hover:shadow-lg transition-all duration-500 delay-600 transform"
            ...
            <div class="h-56 border-2 border-dashed border-gray-200 dark:border-neutral-800 rounded-xl flex flex-col items-center justify-center text-gray-300 dark:text-neutral-700 group hover:border-[#D32030] dark:hover:border-[#D32030] hover:bg-red-50/50 dark:hover:bg-red-900/10 transition-all duration-300">
                <svg class="w-10 h-10 mb-2 group-hover:scale-110 group-hover:text-[#D32030] transition-all duration-300 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 12l3-3 3 3 4-4M3 21h18"/></svg>
        ...
        <div class="bg-white dark:bg-[#151515] rounded-2xl border border-gray-200 dark:border-neutral-800 p-6 shadow-sm hover:shadow-lg transition-all duration-500 delay-700 transform"
            ...
            <div class="h-56 border-2 border-dashed border-gray-200 dark:border-neutral-800 rounded-xl flex flex-col items-center justify-center text-gray-300 dark:text-neutral-700 group hover:border-[#D32030] dark:hover:border-[#D32030] hover:bg-red-50/50 dark:hover:bg-red-900/10 transition-all duration-300">
                <svg class="w-10 h-10 mb-2 group-hover:scale-110 group-hover:text-[#D32030] transition-all duration-300 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 19v-6m4 6V9m4 10V5M3 21h18"/></svg>
    ...
    <div class="bg-white dark:bg-[#151515] rounded-2xl border border-gray-200 dark:border-neutral-800 overflow-hidden shadow-sm hover:shadow-lg transition-all duration-500 delay-1000 transform"
        ...
        <div class="px-6 py-5 border-b border-gray-100 dark:border-neutral-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <a href="{{ route('inventario.index') }}" class="group text-xs font-semibold text-[#D32030] dark:text-red-500 hover:text-[#B91C2C] dark:hover:text-red-400 transition flex items-center gap-1">
