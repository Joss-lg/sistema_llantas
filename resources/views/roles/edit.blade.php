...
<div class="max-w-2xl mx-auto transition-colors duration-300 relative px-4 py-6" x-data="{ cargado: false }" x-init="setTimeout(() => cargado = true, 50)">
    ...
    <div class="relative z-10 space-y-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 transform transition-all duration-700 ease-out"
            ...
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white transition-colors">Editar Rol</h1>
                <p class="text-sm text-gray-500 dark:text-neutral-400 mt-1 transition-colors">Modifica la información del rol <span class="text-[#D32030] font-semibold">#{{ $role->id }}</span>.</p>
            </div>
